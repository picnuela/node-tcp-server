...
var createLooper = require('./iostream').createLooper;
var IOReceptor = require('./ioreceptor').IOReceptor;
var IOBridge = require('./iobridge').IOBridge;
var NET = require('net');

/**
 * Bridged Stream into a TCPSocket
 * @returns {TCPSocket}
 */
class TCPSocket extends IOStream {
  /**
   ...
   */
  open(options) {
    return _tcpsocketOpen(this, options);
  }
  /**
   * Stream Opens/Starts Request
   * @param {Object} options Define <b>"host"</b> and <b>"port"</b> properties.
  ...
  createBridge(ipaddress) {
    return _tcpsocketCreateBridge(this, ipaddress);
  }
}
/**
 * @param {IOStream} io
 ...
 * @returns {IOStream}
 */
function _tcpsocketCreateBridge(io, ipaddress) {
  /** @type {IOStream}  */
  let bridge;
 ...
 * @returns {IOStream}
 */
function _tcpsocketOpen(io, options) {
  options = Fn.extends({
    'host': io.host,
    'port': io.port
  }, options);
